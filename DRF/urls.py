...
from DRFApi.views import Filter_StudentListAPI   # -- Filtering
...
urlpatterns = [
    path('admin/', admin.site.urls),
    path('students/filter/', Filter_StudentListAPI.as_view(), name="filtering"),
    path('auth/', include('rest_framework.urls')),
]
